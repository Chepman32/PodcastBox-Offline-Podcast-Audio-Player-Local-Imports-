...
/**
 * Component100 - Reusable UI component
 * Features: hover, edgeSwipe gestures
 * Animations: onFocusTransition, onPressScaleSpring, onDismissSwipe, onRevealFling
 */
export const Component100: React.FC<Component100Props> = ({
  style,
  onPress,
  accessibilityLabel = 'Component100',
  ...props
}) => {
  ...
  // Hover state managed by Pressable
  const edgeSwipeGesture = Gesture.Pan().onStart(() => { runOnJS(onEdgeSwipe)(); });
