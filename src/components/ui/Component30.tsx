...
/**
 * Component30 - Reusable UI component
 * Features: tap, pan gestures
 * Animations: onFocusTransition, onPressScaleSpring, onDismissSwipe, onRevealFling
 */
export const Component30: React.FC<Component30Props> = ({
  style,
  onPress,
  accessibilityLabel = 'Component30',
  ...props
}) => {
  ...
  const panGesture = Gesture.Pan().onUpdate((e) => { translateX.value = e.translationX; translateY.value = e.translationY; });
